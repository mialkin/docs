...
[↑ Backing up to Yandex Object Storage with `rclone`](https://yandex.cloud/en/docs/tutorials/archive/storage-backup-rclone).
...
```bash
rclone ls MY_S3_CONNECTION_NAME:BUCKET_NAME
```
