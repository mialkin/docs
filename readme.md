...
- [MongoDB, Neo4j](databases/nosql/mongodb.md)
...
- [Hostage situation](design/hostage-situation.md)
...
- [Idempotence. Safe and idempotent HTTP methods](programming/idempotence.md)
