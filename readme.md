...
- [Covering, composite, partial index, cardinality, index selectivity](databases/relational/indexes.md)
- [CTE. Window function. `HAVING`](databases/relational/relationalcte/cte.md)
- [EAV model](databases/relational/eav.md)
- [Isolation levels and read phenomena](databases/relational/isolation-levels/isolation-levels.md)
  - [PostgreSQL isolation levels](databases/relational/isolation-levels/postgres/isolation-levels.md)
  - [SQL Server isolation levels](databases/relational/isolation-levels/sql-server/isolation-levels.md)
- [N + 1 query problem. Natural, surrogate key](databases/relational/n-plus-one.md)
- [OLTP, OLAP](databases/relational/oltp-vs-olap.md)
- [Optimistic and pessimistic concurrency](databases/relational/optimistic-vs-pessimistic-concurrency.md)
- [PostgreSQL. `psql`. `pg_dump`. `dropdb`. `createdb`. `pg_restore`](databases/relational/postgres/postgres.md)
  - [System catalog, schemas, tablespaces, relations, files and forks, pages, TOAST](databases/relational/postgres/data-organization.md)
  - [B-tree, hash index, `CLUSTER`](databases/relational/postgres/indexes/indexes.md)
  - [↑ QPT-13 YouTube playlist](https://www.youtube.com/playlist?list=PLaFqU3KCWw6JW80WBHPOe-SMJD2NOjmge).
    - [Demo database](databases/relational/postgres/qpt-13/demo-database/demo-database.md)
    - [Sequential access](databases/relational/postgres/qpt-13/sequential-access.md)
    - [Index access](databases/relational/postgres/qpt-13/index-access.md)
    - [Bitmap scan](databases/relational/postgres/qpt-13/bitmap-scan/bitmap-scan.md)
    - [Nested loop join](databases/relational/postgres/qpt-13/nested-loop-join/nested-loop-join.md)
    - [Hash joins](databases/relational/postgres/qpt-13/hash-joins/hash-joins.md)
    - [Merge joins and sorting](databases/relational/postgres/qpt-13/merge-joins-sorting/merge-joins-sorting.md)
    - [Statistics](databases/relational/postgres/qpt-13/statistics/statistics.md)
- [Replication, sharding, partitioning](databases/relational/replication-sharding-partitioning.md)
- [SQL Server. T-SQL. PL/SQL](databases/relational/tsql.md)
